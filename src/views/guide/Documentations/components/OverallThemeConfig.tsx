    ...
    layout: {
        ...
        sideNavCollapse: false,
            ...
            <div className="mt-10" id="persistence">
                ...
                <p>
                    The persisted state is also stored in the browser&apos;s <code>localStorage</code>. 
                    If you encounter issues where theme changes are not reflected, 
                    you may want to clear the <code>localStorage</code> key named <code>&apos;theme&apos;</code>. 
                    You can do this by running <code>localStorage.removeItem(&apos;theme&apos;)</code> in the browser console.
                </p>
            </div>
        </>
    )
